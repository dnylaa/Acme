                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @else
                                            <div class="img-fluid d-flex align-items-center justify-content-center text-white-50"
                                                style=" height: 100%; background: linear-gradient(rgba(177,156,217,0.6), rgba(255,77,148,0.6)), url('file://wsl.localhost/Ubuntu-22.04/home/dania/my_project/acme/public/assets/img/Hero%20Skincare%20Bg.jpg') center/cover no-repeat;">
                                                Acme Image
                                            </div>
                                        @endif
                                    </div>
